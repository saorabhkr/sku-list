...
(function() {
  /**
   *   @class: Comman Class as Helper
   *   @description: Used to pass data to display in side modal box
   ...
   */
  var SPModal = function(el, opts) {

    this.modal = el;
    this.triggerBtn = $(document).find('[data-trigger-modal="' + this.modal.id + '"]')
    this.closeBtn   = $(this.modal).find('[data-close-modal]');
